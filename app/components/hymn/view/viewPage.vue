    ...
    <div class="hidden md:grid gap-10">
      ...
      >
        ...
        >
          ...
          >
            <div v-if="j == 0">
              <p class="text-gray-500 dark:text-gray-400 text-xl capitalize pb-5 hidden md:block">
                {{ languageLabel(i) }}
              </p>
            </div>
            ...
            >
              <p
                ...
                class="text-primary font-semibold leading-loose"
              >
                {{ refrainLabel(i) }}
              </p>
              <p
                v-else
                class="font-bold leading-loose text-black dark:text-white"
              >
    ...
    <div class="md:hidden">
      ...
      >
        ...
        <div class="grid gap-10">
          <div
            v-for="(stanza, j) of hymn.stanzas"
            :key="j"
            class="w-full"
            :class="textSize()"
          >
            <div class="text-gray-800 dark:text-gray-200 leading-loose">
              ...
              <div class="space-y-1">
                <p
                  v-for="(line, k) of stanza.verse.split('\n')"
                  :key="k"
                  class="first-letter:uppercase"
                >
                  {{ line }}
